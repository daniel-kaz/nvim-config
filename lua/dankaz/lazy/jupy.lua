...
--         config = function ()
--             vim.api.nvim_set_hl(0,"JupyniumMarkdownCellContent", {bg= 0x181b1c})
--             vim.api.nvim_set_hl(0,"JupyniumMarkdownCellSeparator", {bg= 0x181b1c})
--             vim.api.nvim_set_hl(0,"JupyniumCodeCellSeparator", {bg= 0x181b1c})
--         end
--     },
-- }
